...
int main()
{
  ...
  char * valueString = 
    XdmfSparseMatrixGetName((XDMFSPARSEMATRIX *)((void *)matrix));
  ...
  valueString = 
    XdmfSparseMatrixGetValuesString((XDMFSPARSEMATRIX *)((void *)matrix), 
				    &status);
  ...
  XDMFITEM * readItem = XdmfReaderRead(reader, "matrixfile.xmf", &status);
  XDMFGRAPH * readGraph = XdmfGraphCast(readItem);
  ...
  XDMFATTRIBUTE * readAttribute2 = 
    XdmfGraphGetAttributeByName(readGraph, "Attribute 1");
  ...
  XDMFATTRIBUTE * readAttribute3 = 
    XdmfGraphGetAttributeByName(readGraph, "Attribute 2");
