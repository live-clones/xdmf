...
int main(int, char **)
{
	...
	shared_ptr<XdmfMap> newMap = XdmfMap::New();
	remoteIDset.clear();
        nodeIDMap.clear();
	taskIDMap.clear();
	...
	nodeIDMap.insert(std::pair<int, std::set<int> >(2, remoteIDset));
	remoteIDset.clear();
        remoteIDset.insert(3);
        nodeIDMap.insert(std::pair<int, std::set<int> >(3, remoteIDset));
	remoteIDset.clear();
        remoteIDset.insert(7);
        remoteIDset.insert(9);
        nodeIDMap.insert(std::pair<int, std::set<int> >(4, remoteIDset));
	taskIDMap.insert(std::pair<int, std::map<int, std::set<int> > >(1, nodeIDMap));
	nodeIDMap.clear();
	remoteIDset.clear();
        remoteIDset.insert(3);
        remoteIDset.insert(6);
        remoteIDset.insert(8);
        nodeIDMap.insert(std::pair<int, std::set<int> >(5, remoteIDset));
	remoteIDset.clear();
	remoteIDset.insert(3);
        nodeIDMap.insert(std::pair<int, std::set<int> >(7, remoteIDset));
	remoteIDset.clear();
        remoteIDset.insert(7);
        remoteIDset.insert(9);
        nodeIDMap.insert(std::pair<int, std::set<int> >(9, remoteIDset));
	taskIDMap.insert(std::pair<int, std::map<int, std::set<int> > >(2, nodeIDMap));
	newMap->setMap(taskIDMap);
	reggrid->insert(newMap);
