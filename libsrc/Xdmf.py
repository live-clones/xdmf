...
class XdmfDiff(_object):
    ...
    def __init__(self, *args): 
        this = _Xdmf.new_XdmfDiff(*args)
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _Xdmf.delete_XdmfDiff
    __del__ = lambda self : None;
    def GetDiffs(self, *args): return _Xdmf.XdmfDiff_GetDiffs(self, *args)
    def SetIgnoreTime(self, value = True): return _Xdmf.XdmfDiff_SetIgnoreTime(self, value)
    def GetIgnoreTime(self): return _Xdmf.XdmfDiff_GetIgnoreTime(self)
    def SetIgnoreGeometry(self, value = True): return _Xdmf.XdmfDiff_SetIgnoreGeometry(self, value)
    def GetIgnoreGeometry(self): return _Xdmf.XdmfDiff_GetIgnoreGeometry(self)
    def SetIgnoreTopology(self, value = True): return _Xdmf.XdmfDiff_SetIgnoreTopology(self, value)
    def GetIgnoreTopology(self): return _Xdmf.XdmfDiff_GetIgnoreTopology(self)
    def SetIgnoreAllAttributes(self, value = True): return _Xdmf.XdmfDiff_SetIgnoreAllAttributes(self, value)
    def GetIgnoreAllAttributes(self): return _Xdmf.XdmfDiff_GetIgnoreAllAttributes(self)
    def SetDisplayFailuresOnly(self, value = True): return _Xdmf.XdmfDiff_SetDisplayFailuresOnly(self, value)
    def GetDisplayFailuresOnly(self): return _Xdmf.XdmfDiff_GetDisplayFailuresOnly(self)
    def SetVerboseOutput(self, value = True): return _Xdmf.XdmfDiff_SetVerboseOutput(self, value)
    def GetVerboseOutput(self): return _Xdmf.XdmfDiff_GetVerboseOutput(self)
    def SetCreateDiffFile(self, value = True): return _Xdmf.XdmfDiff_SetCreateDiffFile(self, value)
    def GetCreateDiffFile(self): return _Xdmf.XdmfDiff_GetCreateDiffFile(self)
    def SetDiffFileName(self, *args): return _Xdmf.XdmfDiff_SetDiffFileName(self, *args)
    def GetDiffFileName(self): return _Xdmf.XdmfDiff_GetDiffFileName(self)
    def SetRelativeError(self, *args): return _Xdmf.XdmfDiff_SetRelativeError(self, *args)
    def GetRelativeError(self): return _Xdmf.XdmfDiff_GetRelativeError(self)
    def SetAbsoluteError(self, *args): return _Xdmf.XdmfDiff_SetAbsoluteError(self, *args)
    def GetAbsoluteError(self): return _Xdmf.XdmfDiff_GetAbsoluteError(self)
    def IncludeGrid(self, *args): return _Xdmf.XdmfDiff_IncludeGrid(self, *args)
    def IgnoreGrid(self, *args): return _Xdmf.XdmfDiff_IgnoreGrid(self, *args)
    def IncludeAttribute(self, *args): return _Xdmf.XdmfDiff_IncludeAttribute(self, *args)
    def IgnoreAttribute(self, *args): return _Xdmf.XdmfDiff_IgnoreAttribute(self, *args)
    def ParseSettingsFile(self, *args): return _Xdmf.XdmfDiff_ParseSettingsFile(self, *args)
    def AreEquivalent(self): return _Xdmf.XdmfDiff_AreEquivalent(self)
XdmfDiff_swigregister = _Xdmf.XdmfDiff_swigregister
