...
public:
	...
	virtual boost::shared_ptr<XdmfUnstructuredGrid> convert(const boost::shared_ptr<XdmfUnstructuredGrid> gridToConvert, const boost::shared_ptr<XdmfHDF5Writer> heavyDataWriter) const = 0;
...
public:
	...
	boost::shared_ptr<XdmfUnstructuredGrid> convert(const boost::shared_ptr<XdmfUnstructuredGrid> gridToConvert, const boost::shared_ptr<XdmfHDF5Writer> heavyDataWriter) const
	{
...
boost::shared_ptr<XdmfUnstructuredGrid> XdmfTopologyConverter::convert(const boost::shared_ptr<XdmfUnstructuredGrid> gridToConvert, const boost::shared_ptr<const XdmfTopologyType> topologyType,
	const boost::shared_ptr<XdmfHDF5Writer> heavyDataWriter) const
{
	...
	if(converter)
	{
		boost::shared_ptr<XdmfUnstructuredGrid> toReturn = converter->convert(gridToConvert, heavyDataWriter);
		delete converter;
		return toReturn;
	}
	else
