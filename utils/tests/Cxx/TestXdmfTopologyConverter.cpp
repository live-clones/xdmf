...
int main(int, char *)
{
	...
	boost::shared_ptr<XdmfUnstructuredGrid> hexGrid = XdmfUnstructuredGrid::New();
	 ...
	 */
	boost::shared_ptr<XdmfUnstructuredGrid> hex64Grid = converter->convert(hexGrid, XdmfTopologyType::Hexahedron_64());
	 ...
	 */
	boost::shared_ptr<XdmfUnstructuredGrid> hex125Grid = converter->convert(hexGrid, XdmfTopologyType::Hexahedron_125());
	 ...
	 */
	boost::shared_ptr<XdmfUnstructuredGrid> newHexGrid = converter->convert(hex64Grid, XdmfTopologyType::Hexahedron());
