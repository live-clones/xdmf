                      ...
                      const int fapl)
{
  ...
  if(datatype != -1) {
    ...
    for(int i = 0; i < previousControllers.size(); i++)// it is assumed that the array will have at least one controller, if it didn't have one a temporary one was generated
    {
