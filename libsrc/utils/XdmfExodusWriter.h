...
class XdmfExodusWriter
{
  ...
  private:
     ...
     *
     * @param exoElemType a char * containing the elem_type of the current topology being written
     *
     * @return a std::string of the exodus ii topology type equivalent to the xdmf topology being written
     */
