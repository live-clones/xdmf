...
#ifndef __vtkXdmfReader2_h
#define __vtkXdmfReader2_h

#include "vtkDataReader.h"

class vtkXdmfDocument;

class VTK_EXPORT vtkXdmfReader2 : public vtkDataReader
{
public:
  static vtkXdmfReader2* New();
...
private:
  vtkXdmfReader2(const vtkXdmfReader2&); // Not implemented
  void operator=(const vtkXdmfReader2&); // Not implemented
//ETX
};
